...
export default function TrialSignupForm() {
  ...
  const openLiveChat = () => {
    ...
    if (typeof window !== 'undefined') {
      ...
      try {
        ...
        eval("if (window.Tawk_API && window.Tawk_API.maximize) window.Tawk_API.maximize()");
      } catch {
  ...
  const contactOptions: ContactOption[] = [
    ...
    },
    {
      ...
      title: "Email",
      action: "mailto:trial@kyostream.com",
      buttonText: "Email Us",
      primary: true,
    ...
    },
    {
      ...
      title: "Discord",
      action: "https://discord.gg/kyostream",
      buttonText: "Discord",
      primary: true,
  ...
  return (
    <section id="trial-signup" className="py-10 md:py-16 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4">Get Your Free IPTV Trial Today</h2>
            <p className="text-muted-foreground text-sm md:text-base max-w-2xl mx-auto">
              Contact us through any of these channels for your free trial setup.
            </p>
          </div>
          ...
          <div className="mt-6 md:mt-8 text-center text-xs md:text-sm text-muted-foreground">
            <p>
              Please provide your device type, email, and country when contacting us.
            </p>
            <p className="mt-2">
              By requesting a free trial, you agree to our <a href="/terms" className="text-accent-primary hover:underline">Terms of Service</a> and <a href="/privacy" className="text-accent-primary hover:underline">Privacy Policy</a>.
            </p>
          </div>
        </div>
      </div>
...
function ContactOptionContent({ option }: { option: ContactOption }) {
  return (
    <>
      <div className={`flex-shrink-0 p-3 md:p-4 rounded-lg ${option.iconBg} group-hover:scale-105 transition-transform duration-300`}>
