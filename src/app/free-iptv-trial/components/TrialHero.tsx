...
export default function TrialHero() {
  ...
  return (
    <section className="relative overflow-hidden" aria-labelledby="free-trial-heading">
      <div className="container mx-auto px-4 py-12 md:py-20 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 id="free-trial-heading" className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight tracking-tight mb-6">
            <span className="text-foreground drop-shadow-sm">Start Your Free</span>
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-accent-primary to-accent-primary/80 mt-1">
              IPTV Trial with KyoStream
            </span>
          </h1>
          
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Test our premium IPTV service with a free 24-hour trial. Experience high-quality streaming, extensive channel selection, and reliable service before you commit.
          </p>
          ...
          >
            Start My Free IPTV Trial <ArrowRight className="ml-2 h-5 w-5" aria-hidden="true" />
          </Button>
        </div>
      </div>
    </section>
